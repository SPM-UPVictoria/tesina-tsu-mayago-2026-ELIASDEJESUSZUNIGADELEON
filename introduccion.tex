...
A nivel de la capa de presentación visual (frontend), la literatura académica y técnica demuestra el rendimiento superior de los portales construidos con arquitecturas \textit{Single Page Application} (SPA) empleando librerías como React frente a los enfoques tradicionales de múltiples páginas \cite{mikowski2013single}. Las evaluaciones de rendimiento evidencian que las SPA optimizan significativamente los tiempos de respuesta y el ancho de banda del servidor, al delegar la lógica de presentación al navegador y renderizar dinámicamente los componentes de la interfaz sin recargar páginas completas \cite{flanagan2020javascript}. Dicho consenso fundamenta de manera teórica la selección de React y Bootstrap para garantizar que el nuevo desarrollo sea una herramienta ágil y verdaderamente responsiva.
