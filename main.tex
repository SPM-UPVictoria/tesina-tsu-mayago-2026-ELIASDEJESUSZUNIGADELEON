...
\newcommand{\NombreAlumno}{Elías de Jesús Zúñiga de León} % SU NOMBRE COMPLETO
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Rediseño y optimización del portal institucional de la UAT mediante el framework de SharePoint para la mejora de la accesibilidad e integración digital} 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Rediseño y optimización del portal \\institucional de la UAT mediante el framework \\de SharePoint para la accesibilidad e integración digital}
\newcommand{\NombreTSU}{Desarrollo de Software Multiplataforma}
\newcommand{\UnidadEconomica}{Universidad Autónoma de Tamaulipas}
\newcommand{\nasesorempresaria}   {Lic. Elsa Iran Rodriguez Peña}
\newcommand{\nasesorinstitucional}{Dr. Said Polanco Martagón}
\newcommand{\Matricula}           {2430085}  %SU MATRICULA
...
\clearpage
\input{diseno_interfaces}

\clearpage
\input{pantallas_finales}
